...
lstm_model.save('cpu_model-log.h5')
# serialize model to JSON
model_json = lstm_model.to_json()
with open("cpu_model-log.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
lstm_model.save_weights("cpu_model-log-weight.h5")
